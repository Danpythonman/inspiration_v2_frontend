...
const MainPage = ({ imageObject, quoteObject, user, tasks, updateTasks, handleColorChange, handleNameChange, logOut, handleDeleteAccount, handleVerifyDeleteAccount, handleRecommendQuote, handleAPIRequestError }) => {
